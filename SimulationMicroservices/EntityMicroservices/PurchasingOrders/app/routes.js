...
function messageHandler(msg){
    if(msg.type == "start"){
        ...
        .send({ "simID": request.req.body.simID, "opID": request.req.body.opID, "step" : request.req.body.step+1, 
            "timing" : msElapsed ,"serviceName": "PurchasingOrders", "apiName": request.type,"date":datestring,
...
module.exports = function (app) {
    ...
    app.get('/purchasingorder/:purchasingorder_id', function (req, res) {
        insertQueue("GET-/purchasingorder",req,res);
    });

    app.post('/purchasingorder', function (req, res) {
        insertQueue("POST-/purchasingorder",req,res);
    });

    app.put('/purchasingorder/:purchasingorder_id', function (req, res){
        insertQueue("PUT-/purchasingorder",req,res);
    });
    ...
    app.get('/purchasingorders', function(req,res){
        insertQueue("GET-/purchasingorders",req,res)
    });
