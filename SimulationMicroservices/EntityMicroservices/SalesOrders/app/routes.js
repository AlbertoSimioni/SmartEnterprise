...
module.exports = function (app) {
    ...
    app.get('/salesorder/:salesorder_id', function (req, res) {
        ...
        .send({ "simID": req.body.simID, "opID": req.body.opID, "step" : req.body.step+1, 
            "timing" : msElapsed ,"serviceName": "SalesOrders", "apiName": "GET-/salesorder","date":datestring})
        .end();
    ...
    app.post('/salesorder', function (req, res) {
        ...
        wampSession.publish('salesorders',  [], {type: "new" , opID: req.body.opID});
        ...
        .type('json')
        .send({ "simID": req.body.simID, "opID": req.body.opID, "step" : req.body.step+1, 
            "timing" : msElapsed ,"serviceName": "SalesOrders", "apiName": "POST-/salesorder","date":datestring})
        .end();
    ...
    app.put('/salesorder/:salesorder_id', function (req, res){
        ...
        var hrstart2 = process.hrtime();
        console.log(msElapsed);
        wampSession.publish('salesorders',  [], {type: "update" , opID: req.body.opID});
        unirest.post('http://metrics-collector:8080/timingSample')
        //unirest.post('http://localhost:8080/timingSample')
        .headers({'Accept': 'application/json', 'Content-Type': 'application/json'})
        .type('json')
        .send({ "simID": req.body.simID, "opID": req.body.opID, "step" : req.body.step+1, 
            "timing" : msElapsed ,"serviceName": "SalesOrders", "apiName": "PUT-/salesorder","date":datestring})
        .end();
    ...
    app.delete('/salesorder/:availability_id', function (req, res) {
        ...
        var hrstart2 = process.hrtime();
        console.log(msElapsed);
        wampSession.publish('salesorders',  [], {type: "delete" , opID: req.body.opID});
        unirest.post('http://metrics-collector:8080/timingSample')
        //unirest.post('http://localhost:8080/timingSample')
        .headers({'Accept': 'application/json', 'Content-Type': 'application/json'})
        .type('json')
        .send({ "simID": req.body.simID, "opID": req.body.opID, "step" : req.body.step+1, 
            "timing" : msElapsed ,"serviceName": "SalesOrders", "apiName": "DELETE-/salesorder","date":datestring})
        .end();
    ...
    app.get('/salesorders', function(req,res){
        ...
        .type('json')
        .send({ "simID": req.body.simID, "opID": req.body.opID, "step" : req.body.step+1, 
            "timing" : msElapsed ,"serviceName": "SalesOrders", "apiName": "GET-/salesorders","date":datestring})
        .end();
