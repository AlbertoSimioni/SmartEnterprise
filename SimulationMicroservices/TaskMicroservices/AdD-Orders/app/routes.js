...
module.exports = function (app) {
    app.get('/currentpurchasingorders', function (req, res) {
        ...
        .end(function(response){
                ...
                .send({ "simID": req.body.simID, "opID": req.body.opID, "step" : req.body.step+3, 
                    "timing" : msElapsed2 ,"serviceName": "AdD-Orders", "apiName": "GET-R/currentpurchasingorders","date":datestring2})
                .end();
                res.send("A").end();
        });
        ...
        .type('json')
        .send({ "simID": req.body.simID, "opID": req.body.opID, "step" : req.body.step+1, 
            "timing" : msElapsed ,"serviceName": "AdD-Orders", "apiName": "GET-/currentpurchasingorders","date":datestring})
        .end();
    ...
    app.get('/currentsalesorders', function (req, res) {
        ...
        .end(function(response){
                ...
                .type('json')
                .send({ "simID": req.body.simID, "opID": req.body.opID, "step" : req.body.step+3, 
                    "timing" : msElapsed2 ,"serviceName": "AdD-Orders", "apiName": "GET-R/currentsalesorders","date":datestring2})
                .end();
                res.send("A").end();
        });
        ...
        .type('json')
        .send({ "simID": req.body.simID, "opID": req.body.opID, "step" : req.body.step+1, 
            "timing" : msElapsed ,"serviceName": "AdD-Orders", "apiName": "GET-/currentsalesorders","date":datestring})
        .end();
