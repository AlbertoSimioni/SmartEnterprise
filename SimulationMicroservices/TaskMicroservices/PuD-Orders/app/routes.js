...
module.exports = function (app) {
    ...
    app.get('/currentpurchasingorders', function (req, res) {
        ...
        .end(function(response){
                ...
                .send({ "simID": req.body.simID, "opID": req.body.opID, "step" : req.body.step+3, 
                    "timing" : msElapsed2 ,"serviceName": "PuD-Orders", "apiName": "GET-R/currentpurchasingorders","date":datestring2})
                .end();
                res.send("A").end();
        });
    ...
    app.get('/currentsalesorders', function (req, res) {
        ...
        .end(function(response){
                ...
                .type('json')
                .send({ "simID": req.body.simID, "opID": req.body.opID, "step" : req.body.step+3, 
                    "timing" : msElapsed2 ,"serviceName": "PuD-Orders", "apiName": "GET-R/currentsalesorders","date":datestring2})
                .end();
                res.send("A").end();
        });
...
app.put('/confirmpurchasingorder', function (req, res) {
        ...
        .type('json')
        .send({ "simID": req.body.simID, "opID": req.body.opID, "step" : req.body.step+1, 
            "timing" : msElapsed ,"serviceName": "PuD-Orders", "apiName": "PUT-/confirmpurchasingorder","date":datestring})
        .end();
    ...
    app.post('/newpurchasingorder', function (req, res) {
        ...
        .end(function(response){
                ...
                .type('json')
                .send({ "simID": req.body.simID, "opID": req.body.opID, "step" : req.body.step+3, 
                    "timing" : msElapsed2 ,"serviceName": "PuD-Orders", "apiName": "POST-R/newpurchasingorder","date":datestring2})
                .end();
                res.send("A").end();
        });
        ...
        .type('json')
        .send({ "simID": req.body.simID, "opID": req.body.opID, "step" : req.body.step+1, 
            "timing" : msElapsed ,"serviceName": "PuD-Orders", "apiName": "POST-/newpurchasingorder","date":datestring})
        .end();

    });

    app.put('/addpurchasingorder/:availability_id', function (req, res){
        ...
        .end(function(response){
                ...
                .type('json')
                .send({ "simID": req.body.simID, "opID": req.body.opID, "step" : req.body.step+3, 
                    "timing" : msElapsed2 ,"serviceName": "PuD-Orders", "apiName": "PUT-R/addpurchasingorder","date":datestring2})
                .end();
                res.send("A").end();
        });
        ...
        .type('json')
        .send({ "simID": req.body.simID, "opID": req.body.opID, "step" : req.body.step+1, 
            "timing" : msElapsed ,"serviceName": "PuD-Orders", "apiName": "PUT-/addpurchasingorder","date":datestring})
        .end();
    });

    // delete a sampledata
    app.delete('/purchasingorder/:availability_id', function (req, res) {
        ...
        .end(function(response){
                ...
                .type('json')
                .send({ "simID": req.body.simID, "opID": req.body.opID, "step" : req.body.step+3, 
                    "timing" : msElapsed2 ,"serviceName": "PuD-Orders", "apiName": "DELETE-R/purchasingorder","date":datestring2})
                .end();
                res.send("A").end();
        });
        ...
        .type('json')
        .send({ "simID": req.body.simID, "opID": req.body.opID, "step" : req.body.step+1, 
            "timing" : msElapsed ,"serviceName": "PuD-Orders", "apiName": "DELETE-/purchasingorder","date":datestring})
        .end();
    });
